...
@section('content')
  ...
  <div class="hero-slide owl-carousel site-blocks-cover">
    <div class="intro-section" style="background-image: url({{asset('img/public/hero_1.jpg')}});">
      <div class="container">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 mb-4 mb-lg-0">
            <img src="" alt="Image " class="img-fluid img-overlap">
          </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-5 align-self-end">
          <img src="{{asset('img/public/img_transparent.png')}}" alt="Image" class="img-fluid">
        </div>
        <div class="col-lg-7 align-self-center mb-5">

          <div class="bg-black  quote-form-wrap wrap text-white">
            <div class="mb-5">
              <h3 class="section-subtitle">OBTENEZ UN DEVIS</h3>
      ...
      <div class="projects-carousel-wrap">
        <div class="owl-carousel owl-slide-3">
          <div class="project-item">
            ...
            <img src="{{asset('img/public/works_1.jpg')}}" alt="Image" class="img-fluid">
          </div>
          <div class="project-item">
            <div class="project-item-contents">
              <a href="#">
            ...
            <img src="{{asset('img/public/works_2.jpg')}}" alt="Image" class="img-fluid">
          </div>
          <div class="project-item">
            <div class="project-item-contents">
              <a href="#">
            ...
            <img src="{{asset('img/public/works_3.jpg')}}" alt="Image" class="img-fluid">
          </div>
          <div class="project-item">
            <div class="project-item-contents">
              <a href="#">
            ...
            <img src="{{asset('img/public/works_4.jpg')}}" alt="Image" class="img-fluid">
          </div>
      ...
      <div class="row">
        <div class="col-md-6 mb-4 mb-md-0">
          <div class="testimonial">
            <img src="{{asset('img/public/person_3_sq.jpg')}}" alt="">
            <blockquote>
        ...
        <div class="col-md-6 mb-4 mb-md-0">
          <div class="testimonial">
            <img src="{{asset('img/public/person_4_sq.jpg')}}" alt="">
            <blockquote>
              <p>&ldquo;Lorem ipsum dolor sit, amet consectetur adipisicing elit. Provident deleniti iusto molestias, dolore vel fugiat ab placeat ea?&rdquo;</p>
            </blockquote>
            <p class="client-name">Matt Keygen</p>
